...
def tampil_halaman(halaman):
    ...
    # Take three columns
    # outputkab = outputkab[['Jenis_Ikan', 'Status', 'KabKota']].copy()
...
def tampil_halaman2(halaman2):
    JUMLAH_PER_HALAMAN = 16
    # Melakukan proses clustering
    df = pd.read_csv("https://storage.googleapis.com/panel-buck/DataCobaNew.csv")
    ...
    if search_query:
        outputkab2 = ikan[
            ...
            ikan['Status'].str.contains(search_query, case=False)
        ]
    elif kota_query:
